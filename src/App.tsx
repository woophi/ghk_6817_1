...
export const App = () => {
  ...
  const submit = () => {
    if (loading) return;
    window.gtag('event', 'ios_jackpot_nov_finish_var1');
    setLoading(true);
                  ...
                  <ButtonMobile
                    ...
                    onClick={() => {
                      if (numbersData[ticketIndex]?.selectedComboIndexes.length) {
                        window.gtag('event', `ios_jackpot_nov_erase_${ticketIndex + 1}_var1`);
                        setNumbersData(
                        ...
                        window.gtag('event', 'ios_jackpot_nov_choose_var1');
                        setNumbersData(
                          numbersData.concat([
                            {
                              comboNumbers: get6Rows(),
              ...
              {numbersData[ticketIndex] && (
                ...
                >
                  ...
                  <ButtonMobile
                    ...
                    size={40}
                    onClick={() => {
                      window.gtag('event', `ios_jackpot_nov_combination_${ticketIndex + 1}_var1`);
                      setNumbersData(
                        numbersData.map((combo, comboIndex) => {
                          if (comboIndex !== ticketIndex) return combo;
    ...
    <>
      ...
      <div className={appSt.bottomBtn}>
        <ButtonMobile
          ...
          view="primary"
          onClick={() => {
            window.gtag('event', 'ios_jackpot_nov_luck_var1');
            setStep('numbers');
          }}
        >
